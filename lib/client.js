...
var explicitSubscriptionCallback = function () {}

var addSubscription = function (topic, messageType, callback,
                                subscribeToTopic) {
...
var removeSubscription = function (topic, messageType, callback) {
  if (callback !== explicitSubscriptionCallback) {
...
DxlClient.prototype.connect = function (callback) {
  ...
  var servers = this._config.brokers.reduce(function (result, broker) {
