...
inherits(DxlClient, events.EventEmitter)
...
DxlClient.prototype.connect = function (callback) {
  if (!Object.keys(this._servers).length) {
    throw new DxlError(
...
DxlClient.prototype.disconnect = function (callback) {
  if (this._mqttClient) {
    this._mqttClient.end(callback)
  }
}

DxlClient.prototype.destroy = function (callback) {
